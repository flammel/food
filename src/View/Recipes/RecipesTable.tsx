...
export default function RecipesTable(props: RecipesTableProps): React.ReactElement {
    ...
    const columns: ColumnDefinition<Recipe> = [
        ...
        },
        {
            id: "calories",
            label: "Calories",
            value: (item: Recipe) => Formatter.calories(nutritionData(item).calories),
        },
        {
            id: "fat",
            label: "Fat",
            value: (item: Recipe) => Formatter.macro(nutritionData(item).fat) + " g",
        },
        {
            id: "carbs",
            label: "Carbs",
            value: (item: Recipe) => Formatter.macro(nutritionData(item).carbs) + " g",
        },
        {
            id: "protein",
            label: "Protein",
            value: (item: Recipe) => Formatter.macro(nutritionData(item).protein) + " g",
        },
    ];
    return (
        <DataTable
